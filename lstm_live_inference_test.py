...
# ==========================================
# EVALUATION & DEPLOYMENT FUNCTIONS
# ==========================================
    ...
    for i in range(runs):
        ...
        while True:
            ...
            with torch.no_grad(), torch.autocast(device_type='cuda', dtype=torch.bfloat16):
                ...
                danger_prob = torch.sigmoid(safe_logits).item() 
...
def deploy_live(checkpoint_path, output_video_path):
    print(f"Loading RoverLSTM Model from {checkpoint_path}...")
    ...
    while True:
        ...
        cv2.imshow("RoverLSTM - Infinite Live Deployment", display_frame)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Live deployment of RoverLSTM in an infinite synthetic world.")
